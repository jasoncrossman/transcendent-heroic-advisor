      ...
      <div className="max-w-3xl mx-auto">
        <div className={`bg-white rounded-[2.5rem] p-10 md:p-16 shadow-xl border border-slate-100 transition-all duration-500 ${step !== 'letter' ? 'opacity-20 blur-sm pointer-events-none' : 'opacity-100'}`}>
          ...
          <div className="space-y-6 text-slate-600 leading-relaxed text-lg">
            ...
            <p>First things first: I’ll be personally signing and mailing your copy of <em>The Wright Exit Strategy</em> this week.</p>
            ...
            <div className="bg-slate-50 p-8 rounded-2xl border-l-4 border-amber-500 my-8">
              ...
              <ul className="space-y-4 text-base">
                <li className="flex gap-3">
                  <span className="font-bold text-amber-600 shrink-0">February 8th:</span> Early Access to course.
                </li>
                <li className="flex gap-3">
                  <span className="font-bold text-amber-600 shrink-0">February 15th:</span> Mastery Portal opens.
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] w-full max-w-2xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
                ...
                <div className="p-10">
                  ...
                  <form onSubmit={handleShippingSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-6">
                      <button type="submit" className="flex-[2] py-4 bg-slate-900 text-white font-bold rounded-xl shadow-lg">Submit & Book Call</button>
              ...
              {step === 'calendar' && (
                <div className="h-[700px] flex flex-col">
                  <div className="p-4 border-b flex justify-between items-center bg-white">
                    <h2 className="font-bold flex items-center gap-2 text-slate-900"><Calendar className="w-5 h-5 text-amber-600" /> Book Strategic Call</h2>
                    <button onClick={() => setStep('final')} className="text-xs font-bold text-amber-600 bg-amber-50 px-3 py-2 rounded-lg">Skip</button>
                  </div>
                  <div className="flex-1">
                    <iframe src="https://calendly.com/bwright-msdi/45-minute-consultation-re-30-second-msg?hide_event_type_details=1&hide_gdpr_banner=1" width="100%" height="100%" frameBorder="0"></iframe>
                  </div>
                </div>
              )}
              ...
              {step === 'final' && (
                <div className="p-16 text-center">
                  ...
                  <p className="text-slate-600 text-lg mb-10 max-w-md mx-auto">Thanks for joining Transcendent Heroic Advisors!</p>
