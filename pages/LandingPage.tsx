...
import { ChevronRight, CheckCircle2, Mail, Gift, Phone, PlayCircle, Calendar, X, Zap, ChevronLeft } from 'lucide-react';
    ...
    <div className="relative min-h-screen">
      ...
      {showPulse && (
        <div className="fixed inset-0 z-[200] bg-slate-950 flex flex-col items-center justify-center">
          ...
          <h2 className="mt-8 text-amber-500 font-bold tracking-[0.3em] uppercase text-sm">Initializing Quantum Suite</h2>
        </div>
      )}
                ...
                <div className="space-y-6 pt-10">
                  <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 text-left">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed mb-4">
                      ...
                      <a href="https://calendly.com/bwright-msdi/45-minute-consultation-re-30-second-msg" className="text-amber-600 font-bold underline hover:text-amber-700">HERE</a>
                    </p>
                  </div>
                </div>
            </div>
